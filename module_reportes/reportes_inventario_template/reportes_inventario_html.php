                        ...
                        <div class="card mb-2">
                            <div class="card-body">
                                <div class="card-body px-0">
                                    <a href="../../fpdf/reportes_inventario.php" target="_blank" class="btn btn-success"><i class="fas fa-file-pdf"></i> Generar reportes </a>
                                </div>
                                <table class="table">
                                  ...
                                  <tbody>
																		<?php foreach($data["Detalles"] as $reporte_inventario):?>
																		<tr>
																			<td><?= $reporte_inventario["prod_nombre"] ?></td>
																			<td><?= $reporte_inventario["prov_nombre"] ?></td>
																			<td><?= $reporte_inventario["inv_fecha_ing"] ?></td>
																			<td><?= $reporte_inventario["inv_fecha_vencimiento"] ?></td>
																			<td><?= $reporte_inventario["prod_precio"] ?></td>
																		</tr>
																		<?php endforeach ?>
																	</tbody>
                              </table>
