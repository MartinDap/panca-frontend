<?php
	if($_SERVER["REQUEST_METHOD"]=="POST"){
		...
		curl_setopt_array($curl, array(
		  ...
		  CURLOPT_POSTFIELDS => 'sucu_nombre=Cevichito%20de%20la%20banda&sucu_direccion=Jr.%20Banda&sucu_telefono=97282213&sucu_departamento=San%20Martin&sucu_provincia=La%20Banda&empr_id=7&sucu_num_mesa=4',
		  CURLOPT_HTTPHEADER => array(
			'Content-Type: application/x-www-form-urlencoded',
