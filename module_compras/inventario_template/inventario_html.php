                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseCompras" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="../proveedores_template/proveedores_html.php">Registrar Inventario</a>
                                    <a class="nav-link" href="layout-sidenav-light.html"></a>
                                </nav>
                            </div> 
                        ...
                        <div class="card mb-2">
                            <div class="card-body">
                                <div class="card-body px-0">
                                    <a href="inventario_registrar_html.php" class="btn btn-primary">Registrar</a>
                                </div>
