<?php 
	if($_SERVER["REQUEST_METHOD"]=="POST"){    
        ...
        curl_setopt_array($curl, array(
          CURLOPT_URL => 'https://panca.informaticapp.com/inventario/'.$_GET['inv_id'],
    ...
    curl_setopt_array($curl, array(
      CURLOPT_URL => 'https://panca.informaticapp.com/proveedores',
      CURLOPT_RETURNTRANSFER => true,
      CURLOPT_ENCODING => '',
      CURLOPT_MAXREDIRS => 10,
      CURLOPT_TIMEOUT => 0,
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Modificar Producto de Inventario "<?= $data["Detalles"]["0"]['prod_nombre'] ?>"</h1>
                        <div class="card mb-4">
                            <div class="card-body">
